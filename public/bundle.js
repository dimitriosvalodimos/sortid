...
var app = (function () {
    ...
    /* src/Searchbar.svelte generated by Svelte v3.24.1 */
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "keyup", /*checkKey*/ ctx[1], false, false, false),
    					listen_dev(button, "click", /*process*/ ctx[2], false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({
    		...
    		checkKey,
    		fetchRedditData,
    		getImportantDatapoints,
    		getNFormattedEntries,
    		process
    	});
    	...
    	return [inputText, checkKey, process, input_input_handler];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(img, "click", /*openLink*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*preview*/ 2 && img.src !== (img_src_value = /*preview*/ ctx[1])) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("upvotes" in $$props) $$invalidate(5, upvotes = $$props.upvotes);
    	...
    	return [title, preview, openLink, author, url, upvotes, comments];
    }
    ...
    class Card extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*upvotes*/ ctx[5] === undefined && !("upvotes" in props)) {
    			console.warn("<Card> was created without expected prop 'upvotes'");
    		}

    		if (/*comments*/ ctx[6] === undefined && !("comments" in props)) {
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(34:2) {#if topRow.length > 0}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	card = new Card({
    			props: {
    				preview: /*post*/ ctx[3].preview,
    				title: /*post*/ ctx[3].title,
    				author: /*post*/ ctx[3].author,
    				url: /*post*/ ctx[3].url,
    				upvotes: /*post*/ ctx[3].upvotes,
    				comments: /*post*/ ctx[3].comments
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*topRow*/ 1) card_changes.preview = /*post*/ ctx[3].preview;
    			if (dirty & /*topRow*/ 1) card_changes.title = /*post*/ ctx[3].title;
    			if (dirty & /*topRow*/ 1) card_changes.author = /*post*/ ctx[3].author;
    			if (dirty & /*topRow*/ 1) card_changes.url = /*post*/ ctx[3].url;
    			if (dirty & /*topRow*/ 1) card_changes.upvotes = /*post*/ ctx[3].upvotes;
    			if (dirty & /*topRow*/ 1) card_changes.comments = /*post*/ ctx[3].comments;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(35:4) {#each topRow as post}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value = /*bottomRow*/ ctx[1];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*bottomRow*/ 2) {
    				each_value = /*bottomRow*/ ctx[1];
    				validate_each_argument(each_value);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(47:2) {#if bottomRow.length > 0}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*bottomRow*/ 2) card_changes.preview = /*post*/ ctx[3].preview;
    			if (dirty & /*bottomRow*/ 2) card_changes.title = /*post*/ ctx[3].title;
    			if (dirty & /*bottomRow*/ 2) card_changes.author = /*post*/ ctx[3].author;
    			if (dirty & /*bottomRow*/ 2) card_changes.url = /*post*/ ctx[3].url;
    			if (dirty & /*bottomRow*/ 2) card_changes.upvotes = /*post*/ ctx[3].upvotes;
    			if (dirty & /*bottomRow*/ 2) card_changes.comments = /*post*/ ctx[3].comments;
    			card.$set(card_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(48:4) {#each bottomRow as post}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	searchbar.$on("displaydata", /*dataSplitter*/ ctx[2]);
    	let if_block0 = /*topRow*/ ctx[0].length > 0 && create_if_block_1(ctx);
    	let if_block1 = /*bottomRow*/ ctx[1].length > 0 && create_if_block(ctx);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const dataSplitter = e => {
    		...
    		if (data.length % 2 == 0) {
    			...
    			$$invalidate(0, topRow = data.splice(0, halfPoint));
    			$$invalidate(1, bottomRow = data);
    		}
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("topRow" in $$props) $$invalidate(0, topRow = $$props.topRow);
    		if ("bottomRow" in $$props) $$invalidate(1, bottomRow = $$props.bottomRow);
    	};
